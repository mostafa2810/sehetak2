...
class _DiagnosisResultsState extends State<DiagnosisResults> {
  ...
  Widget buildDiseaseItem(index)
  {
    ...
    //           SizedBox(height: 5.0,),
    //           Text(
    //             index != null ? diseases[index].disease.name : "text",
    //             style: TextStyle(
    ...
    //               Expanded(
    //                 child: Text(
    //                   diseases[index].disease.icdName.toString()+".",
    //                   maxLines: null,
    //                   style: TextStyle(
    //                       color: Colors.white,
    //                       fontWeight: FontWeight.bold
    ...
    //               Expanded(
    //                 child: Text(
    //                   diseases[index].disease.profName.toString()+".",
    //                   maxLines: null,
    //                   style: TextStyle(
    //                       color: Colors.white,
    //                       fontWeight: FontWeight.bold
    ...
    //               Expanded(
    //                 child: Text(
    //                   buildSpecNames(diseases[index].specialisations).toString()+".",
    //                   maxLines: null,
    //                   style: TextStyle(
    //                       color: Colors.white,
    //                       fontWeight: FontWeight.bold
    ...
    //               Expanded(
    //                 child: Text(
    //                   diseasesDis.isNotEmpty ?
    //                   diseasesDis[index].medicalCondition.toString()+"." :
    //                   "Loading",
    //                   maxLines: null,
    //                   style: TextStyle(
    //                       color: Colors.white,
    ...
    //               onPressed: ()
    //               {
    //                 // if(diseasesDis[index]==null)
    //                 // {
    //                 //   getDiseaseDiscription(diseases[index].disease.id);
    //                 // }
    //                 // while(diseasesDis[index]!=null){}
    //                 // expandedIndex = index;
    //                 // setState(() {});
    //               },
    //             ),
