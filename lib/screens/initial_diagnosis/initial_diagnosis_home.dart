        ...
        body: ConditionalBuilder(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30.0),
                child: Text("This Feature Takes your symptoms and tell you what diseases you could have and is your condition urgent or not."),
              ),
              SizedBox(height: 10.0,),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30.0),
                child: Text("NOTE! THIS DIAGNOSIS ISN'T 100% ACCURATE IF YOUR CONDITION IS CRITICAL OR YOU FEEL LIKE SOMTHING WRONG NOT MENTIONED IN THE DIAGNOSIS GO TO A REAL DOCTOR",
                  style: TextStyle(
                    color: Colors.red,
